...
async def cmd_start(message: Message, db_user: User, is_new_user: bool):
    ...
    await message.answer(
        ...
        f"Bu bot orqali siz Xitoydan va boshqa davlatlardan tovar olib kelish sirlarini o'rganishingiz mumkin.\n\n"
        f"Bizning kurslarda siz quyidagilarni o'rganasiz:\n"
        f"• Taobao orqali arzon tovar topish\n"
        f"• Pinduoduo orqali ulgurji mahsulot olish\n"
        f"• Turkiya, Dubay va Bishkekdan zakaz qilish\n"
        f"• O'zbekistonda optom tovar kanallarini topish\n\n"
